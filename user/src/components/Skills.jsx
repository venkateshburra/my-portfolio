  ...
  return (
    <section id="skills" className="py-24 mesh-bg relative">
      ...
      <div className="max-w-7xl mx-auto px-6" ref={ref}>
        ...
        >
          <span className="font-code text-indigo-400 text-sm tracking-widest uppercase">
            What I work with
          </span>
          ...
          {skillGroups.map((group, gi) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-5">
                <div
                  className={`h-px flex-1 bg-gradient-to-r ${group.color} opacity-30`}
                />
                <span
                  className={`text-xs font-bold uppercase tracking-widest bg-gradient-to-r ${group.color} bg-clip-text text-transparent`}
                >
                  {group.title}
                </span>
                <div
                  className={`h-px flex-1 bg-gradient-to-l ${group.color} opacity-30`}
                />
              </div>
